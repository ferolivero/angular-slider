...
export class ExerciseService {
  ...
  customNormalRangeData$ = this.http.get<CustomNormalRange>(this.normalUrl).pipe(
    tap((data) => console.log('Custom Normal Range', JSON.stringify(data))),
    shareReplay(1),
    catchError(this.handleError)
  );

  customFixedRangeData$ = this.http.get<CustomFixedRange>(this.fixedUrl).pipe(
    tap((data) => console.log('Custom Fixed Range', JSON.stringify(data))),
    shareReplay(1),
    catchError(this.handleError)
  );
